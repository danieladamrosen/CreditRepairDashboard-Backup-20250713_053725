                      ...
                      function proceedWithAccountSave() {
                        ...
                        async function executeNegativeAccountChoreography() {
                          ...
                          if (isLastNegativeAccount) {
                            ...
                            // Step 1: Scroll to Credit Accounts section
                            ...
                            // Step 5: Scroll to Public Records section
                            ...
                            // Step 1: Scroll to just-saved negative account card
                            ...
                            // Step 5: Scroll to next open negative account
                            if (unsavedNegativeAccounts.length > 0) {
                              const nextUnsavedAccount = unsavedNegativeAccounts[0];
                              const rect = nextUnsavedAccount.getBoundingClientRect();
                              const targetScrollY = window.pageYOffset + rect.top - 20;
                              window.scrollTo({ top: targetScrollY, behavior: 'smooth' });
                            }
                          }
